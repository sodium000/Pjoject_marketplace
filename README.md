...
stateDiagram-v2
    ...
    Open --> Assigned: Buyer accepts solver request
    Assigned --> Assigned: Solver creates tasks
    Assigned --> Completed: All tasks completed
    Completed --> [*]
    
    state Assigned {
        [*] --> Pending: Task created
        Pending --> InProgress: Solver starts work
        InProgress --> Submitted: Solver uploads ZIP
        Submitted --> Completed: Buyer accepts
        Submitted --> Rejected: Buyer rejects
        Rejected --> InProgress: Solver reworks
    }
```
...
This project is designed for learning purposes. Feel free to fork, modify, and experiment!

---

**Built for beginner web developers** to understand full-stack development, role-based access control, and smooth UI transitions.
